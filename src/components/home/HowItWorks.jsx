            ...
            <div className="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
              <div className="flex relative pb-12">
                ...
                <div className="flex-grow pl-4">
                  ...
                  <p className="leading-relaxed">
                    Sign up or log in with your credentials or social media
                    accounts.
                  </p>
                </div>
              </div>
              <div className="flex relative pb-12">
                ...
                <div className="flex-grow pl-4">
                  ...
                  <p className="leading-relaxed">
                    Set up your profile and customize your preferences.
                  </p>
                </div>
              </div>
              <div className="flex relative pb-12">
              ...
              <div className="flex relative">
                ...
                <div className="flex-grow pl-4">
                  ...
                  <p className="leading-relaxed">
                    Enjoy the process and be 200% more Productive than before
                  </p>
                </div>
              </div>
            </div>
